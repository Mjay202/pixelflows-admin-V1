...
import { addSDesignSystem} from "@/app/services/api";

export default function AddDesignSystem() {
  ...
  const handleSubmit = async () => {
    ...
    const response = await addSDesignSystem(data);
    if (response.status === true) {
      toast.success("Designadded succesfully!");
      setTimeout(() => {
            ...
            <div className="grid gap-6 mb-4 grid-cols-2 p-3 md:p-4 mt-2">
              ...
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-purple-600 focus:border-purple-600 block w-full p-2.5"
                  placeholder="https://pandadoc.com"
                  required
                />
              </div>
