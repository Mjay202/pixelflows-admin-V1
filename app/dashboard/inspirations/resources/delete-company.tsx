...
export default function Delete({ id, platformName }: { id: any; platformName?: string }) {
  const handleDelete = async () => {
    const response = await deleteResource(id);
    if (response.status == true) {
      toast.success(`Deleted ${platformName} company successfully`);
      setTimeout(() => {
        ...
        <div className="relative p-4 w-full max-w-md max-h-full">
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="md:p-5 text-center flex flex-col items-center">
              ...
              <h3 className="mb-7 text-center px-10 text-base font-semi-bold text-gray-900 ">
                Are you sure you want to delete this <br/>{platformName} company?
              </h3>
              <div className="mb-3">
                <button
                  data-modal-hide={`delete-modal-${id}`}
