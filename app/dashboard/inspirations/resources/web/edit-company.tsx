  ...
  return (
    <div>
      <button
        ...
        data-modal-target="edit-modal-3"
        data-modal-toggle="edit-modal-3"
          ...
          <div className="relative bg-white rounded-lg shadow ">
            ...
            <form className="p-3 md:p-4 mt-2">
              ...
              <div className="flex gap-x-3 justify-center mt-10 mb-3">
                ...
                <button
                  type="button"
                  data-modal-target="edit-modal-4"
                  data-modal-toggle="edit-modal-4"
                  data-modal-hide="edit-modal-3"
