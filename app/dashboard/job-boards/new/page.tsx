...
function JobPage() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-x-4 mt-6 mb-16">
        <div className="border-2 rounded-md p-4 col-span-2 object-contain">
        ...
        <div className="border-2 rounded-md p-4 flex-col items-center justify-items-center place-items-center">
          <div>
            <Image
              ...
              alt="logo"
            />
            <span className="flex gap-2 text-xs mt-4">
